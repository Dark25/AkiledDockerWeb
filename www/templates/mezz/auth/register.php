<form action="" method="post" class="registration-form">
    ...
    <div class="page-content-collider-content-registration-item">
        ...
        <p class="page-content-collider-content-registration-item-text"><?=$lang["Rdescemail"];?></p>
        <input type="text" class="page-content-collider-content-registration-item-input" name="code" placeholder="<?=$lang["Rcodigo"];?>...">
        <input type="text" class="page-content-collider-content-registration-item-input" name="codebueno" value="<?=$security;?>" style="visibility: hidden;width: 0;height: 0;padding: 0;margin: 0;">
    </div>
